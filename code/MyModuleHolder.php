...
class MyModuleHolder extends Page {
    
    static $allowed_children = array("MyModulePage"); // Indicates what kind of children this page type can have.
...
class MyModuleHolder_Controller extends Page_Controller {
